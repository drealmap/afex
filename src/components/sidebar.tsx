...
export const Sidebar = () => {
  ...
  return (
    <div className='h-screen top-0 left-0 fixed w-[6vw]'>
        <div className="flex flex-col items-center justify-between px-4 pt-6 pb-8">
            <div className="flex flex-col items-center gap-6">
                ...
                <div className="flex flex-col gap-4 items-center">
                    <div className=" flex relative cursor-pointer justify-center items-center ">
                    ...
                    <div className=" flex cursor-pointer relative justify-center items-center p-1 ">
